...
defaults to 0.00001. This will cause transactions with fewer PTC/kB fee to be
...
- #5729 `9c4a5a5` Allow unit changes for read-only PerfectCoinAmountField
...
- #5809 `46bfbe7` Add perfectcoin-cli man page
...
- #5849 `41259ca` contrib/init/perfectcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for perfectcoin-tx)
