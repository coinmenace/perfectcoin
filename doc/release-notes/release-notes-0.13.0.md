...
perfectcoin-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/perfectcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
- #7550 `8b958ab` Input-from-stdin mode for perfectcoin-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use PTC/kB (MarcoFalke)
...
- #8257 `ff03c50` Do not ask a UI question from perfectcoind (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for perfectcoind procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of perfectcoind startup (laanwj)
