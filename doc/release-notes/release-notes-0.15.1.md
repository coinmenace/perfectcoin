...
- #10798 `716066d` test perfectcoin-cli (jnewbery)
...
- #11125 `812c870` Add perfectcoin-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in perfectcoin-tx [multisig] output adds (TheBlueMatt)
