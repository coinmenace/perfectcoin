...
enum WalletFeature
{
    ...
    FEATURE_PRE_SPLIT_KEYPOOL = 41000, // Upgraded to HD SPLIT and can have a pre-split keypool
...
public:
     ...
     * on this perfectcoin node, and set to 0 for transactions that were created
