...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s perfectcoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  perfectcoin-tx [options] <hex-tx> [commands]  Update hex-encoded perfectcoin transaction\n" +
              "  perfectcoin-tx [options] -create [commands]   Create hex-encoded perfectcoin transaction\n" +
              "\n";
