...
#ifndef PERFECTCOIN_INTERFACES_NODE_H
#define PERFECTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoin node (perfectcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PERFECTCOIN_INTERFACES_NODE_H
