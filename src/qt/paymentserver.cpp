...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("perfectcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'perfectcoin://' is not a valid URI. Use 'perfectcoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(PERFECTCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // perfectcoin: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
