...
Also test that nodes that send unsupported service bits to perfectcoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if perfectcoind ban behavior changes
    def on_open(self):
        super().on_open()
