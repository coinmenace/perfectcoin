...
# TestP2PConn: A peer we use to send messages to perfectcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes perfectcoind to (reasonably!) disconnect us, so do this last.
    ...
    # perfectcoind's choice of nonce.
    ...
    # Test that perfectcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for perfectcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # perfectcoind will not send blocktxn responses for blocks whose height is
