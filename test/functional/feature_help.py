...
"""Verify that starting perfectcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start perfectcoin with -h for help text")
        ...
        self.log.info("Start perfectcoin with -version for version information")
